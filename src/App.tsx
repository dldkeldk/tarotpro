  ...
  <section id="home" className="relative pt-24 pb-20 px-6 overflow-hidden flex items-center">
    ...
    <div className="max-w-5xl mx-auto w-full">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold leading-[1.1] mb-6 text-gradient">
            타로 상담 중<br /> 막히는 순간,<br />AI가 다음 흐름을 <br /> 함께 잡아드립니다
          </h1>
          <p className="text-lg text-white/50 mb-8 leading-relaxed mx-auto lg:mx-0 max-w-md">
